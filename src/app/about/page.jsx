      ...
      <div className="bg-brand w-full py-16 p-2">
        <div>
          ...
          <p className="text-base text-justify">
            ...
            first flight to the latest multiverse adventures, we wanted a
            single, easy place to browse films, plan watch orders, and share
            personal rankings.
          </p>
        </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="p-4 bg-second rounded">
                ...
                <p className="text-base text-normal text-justify">
                  This website is an independent, fan-made project created
                  solely for entertainment and educational purposes. We are not
                  affiliated with, sponsored by, or in any way officially
                  connected to Marvel Studios, The Walt Disney Company, or any
                  of their subsidiaries or affiliates. All trademarks, character
              ...
              <div className="p-4 bg-second rounded">
                ...
                <p className="text-base text-normal text-justify">
                  ...
                  whenever possible. If you are an artist whose work appears
                  here and you would like it removed or updated, please contact
              ...
              <div className="p-4 bg-second rounded">
                <p className="text-base text-normal text-justify">
                  ...
                  be interpreted as a claim of ownership over any Marvel or
