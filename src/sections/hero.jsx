      ...
      <div className="p-4 flex flex-col gap-4">
        <div className="w-full h-auto bg-second rounded p-4">
          <div className="flex gap-2 items-center py-2">
            <Image src={Fallback} alt="user" width={0} height={0} sizes="100vw" className="w-8 h-auto rounded-full" />
            <div className="flex flex-col">
              <p className="text-base mt-2 font-bold leading-2.5">Joven Bataller</p>
